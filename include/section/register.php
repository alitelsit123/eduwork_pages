<!-- Main modal -->
<div id="registerModal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 min-h-screen md:h-full">
    <div class="relative w-[80%] md:w-[738px] h-full md:h-auto">
        <!-- Modal content -->
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 pt-[69px] pb-[47px] px-[38px] md:px-[158px]">
        <button class="absolute -top-[21px] -right-[28px] w-[56px] h-[56px] bg-[#187cff] rounded-[50%]" type="button" data-modal-toggle="registerModal">
            ...
            <div class="">
                <h1 class="text-[28px] md:text-[24px] text-[#404040] font-semibold mb-[39px]">Register</h1>
                ...
                <input type="text" class="px-[22px] text-[14px] md:text-[10px] w-full border border-[#187cff] bg-white mb-[15px] rounded-[10px] h-[45px] md:h-[40px]" placeholder="Username">
                <input type="text" class="px-[22px] text-[14px] md:text-[10px] w-full border border-[#187cff] bg-white mb-[15px] rounded-[10px] h-[45px] md:h-[40px]" placeholder="Email">
                <input type="text" class="px-[22px] text-[14px] md:text-[10px] w-full border border-[#187cff] bg-white mb-[15px] rounded-[10px] h-[45px] md:h-[40px]" placeholder="Phone Number">
              ...
              <div class="" x-data="{ show: true }">
                <div class="relative">
                  <input placeholder="Confirm Password" :type="show ? 'password' : 'text'" class="block px-[22px] text-[14px] md:text-[10px] w-full border border-[#187cff] bg-white mb-[13px] rounded-[10px] h-[45px] md:h-[40px]                focus:outline-none">
                  <div class="absolute inset-y-0 right-0 pr-[23px] md:pr-[19px] flex items-center text-sm leading-5">
                ...
                <p class="text-[12px]">I have account? <a class="text-[14px] text-[#187cff] font-semibold" href="">Sign In</a></p>
            </div>
        </div>
    </div>
</div>